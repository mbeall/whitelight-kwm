...
class Woo_flickr extends WP_Widget {
  ...
  function widget( $args, $instance ) {
    ...
    echo $before_widget;
    echo $before_title;
    _e( 'Photos on <span>flick<span>r</span></span>', 'woothemes' );
    echo $after_title; ?>
    <div class="wrap fix">
  ...
  function form( $instance ) {
    ...
    <p>
      ...
      <select name="<?php echo $this->get_field_name( 'number' ); ?>" class="widefat" id="<?php echo $this->get_field_id( 'number' ); ?>"><?php for ( $i = 1; $i <= 10; $i += 1 ) { ?>
        <option value="<?php echo $i; ?>" <?php selected( $number, $i ); ?>><?php echo $i; ?></option><?php
      } ?>
      </select>
    </p>
